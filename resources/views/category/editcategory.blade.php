                    ...
                    <form action="{{url('category')}}" method="post">
                        ...
                        <div class="mb-3">
                         ...
                         @enderror
                          <select name="user_id" id="user_id" class="form-control">
                            <option value="">{{$editcategory->user->name}}</option>
                        ...
                        <div class="mb-3">
                          ...
                          @error("name")
                            <div class="alert alert-danger"> {{$message}}</div>
                         @enderror
                          <input value="{{$editcategory->name}}" name="name" type="text" class="form-control" id="category_name" placeholder="enter category name.....">
                        </div>
